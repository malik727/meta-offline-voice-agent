...
DEPENDS = "python3-tabulate python3-python-crfsuite python3-six python3-tqdm python3-setuptools-native"

inherit pypi setuptools3

RDEPENDS_${PN} = "python3-tabulate python3-python-crfsuite python3-six python3-tqdm"
